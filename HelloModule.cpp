...
void HelloModule_t::print ( FILE* f ) {
  ...
  if (T0.values[0]) dat_fprintf<104>(f, "Hello World!\n");
#endif
fflush(f);
}
void HelloModule_t::print ( std::ostream& s ) {
#if __cplusplus >= 201103L
  if (T0.values[0]) dat_prints<104>(s, "Hello World!\n");
#endif
s.flush();
}
...
void HelloModule_t::dump ( FILE* f, int t ) {
}




void HelloModule_t::clock_lo ( dat_t<1> reset ) {
